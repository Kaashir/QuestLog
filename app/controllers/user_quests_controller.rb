class UserQuestsController < ApplicationController
  ...
  def create
    ...
    if @user_quest.save
      redirect_to user_quests_path, notice: 'User quest was successfully created.'
    else
  ...
  def update
    if @user_quest.update(user_quest_params)
      redirect_to user_quests_path, notice: 'User quest was successfully updated.'
    else
  ...
  def destroy
    @user_quest.destroy
    redirect_to user_quests_path, notice: 'User quest was successfully destroyed.'
  end
